 ...
 */
final class Version20250517124104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE message ADD post_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_B6BD307F4B89032C
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE message DROP post_id
        SQL);
    }
}
